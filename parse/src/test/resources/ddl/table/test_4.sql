...
RENAME
TABLE `tb_jbbochhmyq` TO `tb_gacdzagwgx`;
RENAME
TABLE `tb_gacdzagwgx` TO `tb_ldeoaebpbd`;
RENAME
TABLE `tb_moapqhgigh` TO `tb_ggibvidjxp`, `tb_qhpsbbtoys` TO `tb_edphnejvyp`;
RENAME
TABLE `tb_phdwhdaoks` TO `tb_gqurtkvpbu`, `tb_ggibvidjxp` TO `tb_fodfuxeiry`;
RENAME
TABLE `tb_edphnejvyp` TO `tb_iapmhzrbpl`;
RENAME
TABLE `tb_gqurtkvpbu` TO `tb_nxxnnxsqeq`;
RENAME
TABLE `tb_ldeoaebpbd` TO `tb_yujleuojse`;
