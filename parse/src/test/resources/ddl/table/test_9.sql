...
RENAME
TABLE `tb_gcwttmsayc` TO `tb_kwqumakbsd`;
RENAME
TABLE `tb_wvnpljeqpj` TO `tb_moiidbfdwn`, `tb_uvqnvkckwl` TO `tb_avkqzktrix`;
RENAME
TABLE `tb_rcqcegxwfy` TO `tb_rtbwxgyymu`, `tb_kezjbtsebu` TO `tb_qddvuiqxts`;
RENAME
TABLE `tb_qddvuiqxts` TO `tb_dxqnwmkzok`;
RENAME
TABLE `tb_moiidbfdwn` TO `tb_zhkwttzekg`;
