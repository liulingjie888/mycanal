...
RENAME
TABLE `tb_zarsvheubd` TO `tb_hyfkesgbwq`, `tb_hkpkpbxmsl` TO `tb_qxnusuzetz`;
RENAME
TABLE `tb_qxnusuzetz` TO `tb_repwxdxmss`, `tb_hyfkesgbwq` TO `tb_ngxrmtcedz`;
RENAME
TABLE `tb_aihjtxymif` TO `tb_bmbzkqioww`, `tb_ngxrmtcedz` TO `tb_dqutvqabgv`;
CREATE TABLE `tb_zarsvheubd`
(
    `col_kfazghqbis` varbinary(61) NULL DEFAULT '\0',
    `col_ieyszubjeg` time,
