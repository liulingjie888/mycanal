...
RENAME
TABLE `tb_njohawksae` TO `tb_gcvlfgdqvw`;
RENAME
TABLE `tb_lqihveibyp` TO `tb_sugaoprlwz`;
RENAME
TABLE `tb_hxrlnujcrv` TO `tb_qqtidoozva`;
RENAME
TABLE `tb_sugaoprlwz` TO `tb_kubnsybcaf`;
RENAME
TABLE `tb_lsynbmkqdy` TO `tb_ssvyhzkjrr`;
RENAME
TABLE `tb_vkycuerrcd` TO `tb_skbxuhpnhx`, `tb_gcvlfgdqvw` TO `tb_evibhvcuqj`;
RENAME
TABLE `tb_skbxuhpnhx` TO `tb_qlelzwesdb`, `tb_qqtidoozva` TO `tb_bjsplgjemd`;
RENAME
TABLE `tb_ssvyhzkjrr` TO `tb_dxadqwfhhb`, `tb_evibhvcuqj` TO `tb_zflebwrowg`;
