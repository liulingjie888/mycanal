...
RENAME
TABLE `tb_kimzrscxvx` TO `tb_lvhgwlctrm`, `tb_nnobzhrzqo` TO `tb_xplnlwuite`;
RENAME
TABLE `tb_vqdmgdujbc` TO `tb_umtjdrecoe`, `tb_ahtdsnwdye` TO `tb_usrrixyhol`;
RENAME
TABLE `tb_umtjdrecoe` TO `tb_tntbgwfxdz`;
RENAME
TABLE `tb_uvhgkuvnbw` TO `tb_psnsrqzpyc`;
RENAME
TABLE `tb_usrrixyhol` TO `tb_rwgyzdhslb`;
RENAME
TABLE `tb_rwgyzdhslb` TO `tb_wyelqbhtiz`, `tb_psnsrqzpyc` TO `tb_cemigpflpg`;
