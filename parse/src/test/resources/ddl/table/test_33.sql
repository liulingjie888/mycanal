...
RENAME
TABLE `tb_yqtxnjayvs` TO `tb_yynypoqbpb`, `tb_ksdkiecjjm` TO `tb_cwvwctfcqf`;
RENAME
TABLE `tb_yynypoqbpb` TO `tb_qptegarzpr`;
RENAME
TABLE `tb_qptegarzpr` TO `tb_xdckscvkrn`, `tb_cwvwctfcqf` TO `tb_rrtqtkgxpm`;
RENAME
TABLE `tb_eyobhjyopy` TO `tb_ojowyuvyle`, `tb_brasazpupt` TO `tb_xadmpevzmv`;
RENAME
TABLE `tb_xdckscvkrn` TO `tb_xipkollcey`, `tb_xadmpevzmv` TO `tb_xlcxrncdua`;
RENAME
TABLE `tb_xlcxrncdua` TO `tb_vjudeyawut`, `tb_ojowyuvyle` TO `tb_asbrvloeex`;
