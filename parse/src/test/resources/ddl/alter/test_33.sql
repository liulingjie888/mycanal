...
RENAME
TABLE `tb_yajpbebdke` TO `tb_nenripsjcu`;
RENAME
TABLE `tb_nenripsjcu` TO `tb_ocwsozgwid`;
ALTER TABLE `tb_ocwsozgwid`
    ADD UNIQUE INDEX (`col_jerxhroyff`(28));
ALTER TABLE `tb_ocwsozgwid`
    ADD UNIQUE KEY (`col_jerxhroyff`(19),`col_cuctvlzqvd`);
ALTER TABLE `tb_ocwsozgwid`
    ALTER `col_cuctvlzqvd` DROP DEFAULT;
