...
RENAME
TABLE `tb_qwbjzchejk` TO `tb_ezxnrjkvwu`, `tb_pnracjzmkp` TO `tb_jhkrixchju`;
RENAME
TABLE `tb_ezxnrjkvwu` TO `tb_nxqxynvjvx`;
...
ALTER TABLE `tb_jhkrixchju`
    ADD `col_vyizooodsa` longblob AFTER `col_nhdlxtgtvs`;
