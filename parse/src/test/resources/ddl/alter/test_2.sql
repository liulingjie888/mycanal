...
RENAME
TABLE `tb_kyvyqhwcpi` TO `tb_zyynbdsyib`;
RENAME
TABLE `tb_zyynbdsyib` TO `tb_gcqyhapjeh`;
ALTER TABLE `tb_gcqyhapjeh`
    ADD `col_mlfdocnxzd` text CHARACTER SET utf8 FIRST;
