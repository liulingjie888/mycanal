...
RENAME
TABLE `tb_rvyjlenqnq` TO `tb_keyyesvarm`, `tb_epfxexadow` TO `tb_pbwzafanju`;
DROP TABLE tb_pbwzafanju;
ALTER TABLE `tb_keyyesvarm`
    ADD `col_liorapkbnd` mediumint(65) zerofill NOT NULL;
ALTER TABLE `tb_keyyesvarm`
    ADD `col_zixordgmdc` decimal(3, 1);
ALTER TABLE `tb_keyyesvarm`
    ADD COLUMN `col_muylgrtcdh` varchar(79) CHARACTER SET utf8mb4;
ALTER TABLE `tb_keyyesvarm`
    ADD `col_xxwqoepjpj` char AFTER `col_bvvlapfogy`;
...
ALTER TABLE `tb_keyyesvarm`
    ADD COLUMN `col_kyzsjpzdyk` numeric(41);
ALTER TABLE `tb_keyyesvarm`
    ADD UNIQUE INDEX (`col_apojimldou`,`col_liorapkbnd`);
ALTER TABLE `tb_keyyesvarm`
    ALTER COLUMN `col_uvxqqmoipg` DROP DEFAULT;
ALTER TABLE `tb_keyyesvarm`
    ALTER `col_victdeyala` SET DEFAULT NULL;
