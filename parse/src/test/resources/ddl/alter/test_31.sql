...
RENAME
TABLE `tb_oyptksgbxm` TO `tb_djhsoeomxx`;
ALTER TABLE `tb_djhsoeomxx` ADD COLUMN (`col_yuemiunaby` mediumtext, `col_ogwamnrrff` mediumint(37) DEFAULT '1');
ALTER TABLE `tb_djhsoeomxx`
    ADD `col_pvgwkvvphj` text(2345284065) CHARACTER SET utf8;
ALTER TABLE `tb_djhsoeomxx` CHARACTER SET = utf8mb4;
ALTER TABLE `tb_djhsoeomxx`
    ADD UNIQUE (`col_gdmzqziedn`);
ALTER TABLE `tb_djhsoeomxx`
    ADD UNIQUE INDEX `uk_pmearqrlzv` (`col_gdmzqziedn`,`col_yuemiunaby`(31));
