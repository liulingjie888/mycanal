...
RENAME
TABLE `tb_nnxufbaqsg` TO `tb_diurzhsdsd`;
RENAME
TABLE `tb_diurzhsdsd` TO `tb_uhdpyibqnh`;
RENAME
TABLE `tb_uhdpyibqnh` TO `tb_ybgjvtnrkt`;
...
ALTER TABLE `tb_ybgjvtnrkt`
    ADD PRIMARY KEY (`col_llqqqlblzs`);
ALTER TABLE `tb_ybgjvtnrkt`
    ADD UNIQUE (`col_kytprnpyhw`);
ALTER TABLE `tb_ybgjvtnrkt`
    ADD UNIQUE INDEX `uk_flumuisvnj` (`col_qlfphmrfqo`(28));
