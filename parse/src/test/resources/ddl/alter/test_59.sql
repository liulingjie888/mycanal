...
RENAME
TABLE `tb_dvddpenkxa` TO `tb_gqtjkbvgka`, `tb_iccbmqajux` TO `tb_sjauultjmo`;
RENAME
TABLE `tb_sjauultjmo` TO `tb_kwnuzmzxqv`, `tb_gqtjkbvgka` TO `tb_aolqhhluko`;
RENAME
TABLE `tb_aolqhhluko` TO `tb_pengxwurit`;
...
ALTER TABLE `tb_hbheuprskb`
    ADD UNIQUE INDEX (`col_mqqxkezdux`);
ALTER TABLE `tb_hbheuprskb`
    ALTER COLUMN `col_mmxaoivplw` SET DEFAULT '00:00:00';
ALTER TABLE `tb_hbheuprskb`
    ALTER COLUMN `col_mmxaoivplw` DROP DEFAULT;
ALTER TABLE `tb_hbheuprskb`
    ALTER COLUMN `col_mmxaoivplw` DROP DEFAULT;
