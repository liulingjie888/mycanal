...
RENAME
TABLE `tb_iuchtibsiu` TO `tb_oxrpkkhlpd`;
...
ALTER TABLE `tb_yzmdpoldbu`
    ADD COLUMN `col_sdagljipnl` tinyblob AFTER `col_cmeqnxgnwo`;
...
ALTER TABLE `tb_yzmdpoldbu`
    ADD COLUMN `col_hrwaxjpjgr` binary NOT NULL;
ALTER TABLE `tb_yzmdpoldbu`
    ADD UNIQUE `uk_bmkecbeunv` (`col_fefjkkdwwg`(12),`col_cwmggcyoud`);
ALTER TABLE `tb_yzmdpoldbu`
    ALTER COLUMN `col_bwfgathikh` DROP DEFAULT;
