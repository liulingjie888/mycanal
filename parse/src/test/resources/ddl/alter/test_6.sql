...
RENAME
TABLE `tb_cvctdzexnw` TO `tb_yzcwyrztvj`;
ALTER TABLE `tb_yzcwyrztvj`
    ADD `col_oowroifdzd` mediumblob;
...
ALTER TABLE `tb_yzcwyrztvj`
    ADD PRIMARY KEY (`col_ubxpjfudbv`);
ALTER TABLE `tb_yzcwyrztvj`
    ADD UNIQUE KEY `uk_swcaqrkugf` (`col_otmxxxfiqk`,`col_ctnmteeugh`(1));
ALTER TABLE `tb_yzcwyrztvj`
    ADD UNIQUE (`col_jmsmixjrlt`(22), `col_hhnmmxmqtx`);
ALTER TABLE `tb_yzcwyrztvj`
    ALTER `col_otmxxxfiqk` SET DEFAULT '2019';
