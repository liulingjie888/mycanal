...
RENAME
TABLE `tb_plneggfdkn` TO `tb_ctvykdvyzx`;
RENAME
TABLE `tb_ctvykdvyzx` TO `tb_amkojtlotu`;
ALTER TABLE `tb_tmotlxzrja`
    ADD COLUMN `col_kqarzddnnt` date;
ALTER TABLE `tb_tmotlxzrja`
    ADD `col_tgjhdvpopd` year;
...
ALTER TABLE `tb_tmotlxzrja`
    ADD COLUMN `col_nytimponye` enum('enum_or_set_0','enum_or_set_1','enum_or_set_2') NOT NULL;
ALTER TABLE `tb_tmotlxzrja`
    ADD `col_dmorocleic` numeric NULL;
ALTER TABLE `tb_tmotlxzrja` ADD COLUMN (`col_soiyoovkol` char CHARACTER SET utf8mb4 NULL, `col_kpuqcxwuvq` char NOT NULL);
ALTER TABLE `tb_tmotlxzrja`
    ADD `col_wppxtgrjdz` tinyblob;
ALTER TABLE `tb_tmotlxzrja`
    ALTER COLUMN `col_uesfklwmsk` SET DEFAULT '2019-07-04';
