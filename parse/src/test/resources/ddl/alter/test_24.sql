...
RENAME
TABLE `tb_joiefnrthx` TO `tb_bubrykvvkb`;
RENAME
TABLE `tb_bubrykvvkb` TO `tb_fywhebwffn`;
ALTER TABLE `tb_fywhebwffn` DEFAULT CHARACTER SET utf8mb4;
ALTER TABLE `tb_fywhebwffn`
    ADD UNIQUE KEY `uk_keugblaszl` (`col_ctzpiugxrl`(8));
ALTER TABLE `tb_fywhebwffn`
    ADD UNIQUE (`col_ctzpiugxrl`(13));
