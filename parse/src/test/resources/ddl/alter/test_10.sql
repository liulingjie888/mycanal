...
RENAME
TABLE `tb_xckrjwodah` TO `tb_ivkfbysugn`;
RENAME
TABLE `tb_ivkfbysugn` TO `tb_suvmojlodk`;
RENAME
TABLE `tb_suvmojlodk` TO `tb_ubziprstga`;
ALTER TABLE `tb_ubziprstga`
    ADD `col_bjmlsboygo` text AFTER `col_pspaxkzovq`;
