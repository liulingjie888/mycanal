...
RENAME
TABLE `tb_wviibzdwnl` TO `tb_sfwkwlflbi`;
ALTER TABLE `tb_sfwkwlflbi`
    ADD COLUMN `col_zblksizcse` blob AFTER `col_aqelxtcidu`;
...
ALTER TABLE `tb_sfwkwlflbi`
    ADD UNIQUE KEY `uk_odmbvgzhkr` (`col_zblksizcse`(18),`col_ezxxxqpwon`);
