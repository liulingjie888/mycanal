...
RENAME
TABLE `tb_ffitzbfcdd` TO `tb_yvjscngtbt`;
RENAME
TABLE `tb_yvjscngtbt` TO `tb_cnbkkspjcl`;
RENAME
TABLE `tb_cnbkkspjcl` TO `tb_flnycxasap`;
...
ALTER TABLE `tb_flnycxasap`
    ADD `col_olqpjxyqbq` mediumint unsigned zerofill NOT NULL FIRST;
ALTER TABLE `tb_flnycxasap`
    ADD PRIMARY KEY (`col_olqpjxyqbq`);
ALTER TABLE `tb_flnycxasap`
    ADD UNIQUE (`col_sfeoecazoa`, `col_hygoqydgxc`);
ALTER TABLE `tb_flnycxasap`
    ALTER COLUMN `col_hygoqydgxc` SET DEFAULT NULL;
