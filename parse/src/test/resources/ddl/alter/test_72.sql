...
RENAME
TABLE `tb_ybomzxquze` TO `tb_cugzkpefkt`;
...
ALTER TABLE `tb_cugzkpefkt`
    ADD UNIQUE KEY `uk_anpzhhtomg` (`col_xjawafguvi`,`col_xnhktpwgoy`(16));
ALTER TABLE `tb_cugzkpefkt`
    ADD UNIQUE INDEX (`col_vmjyaetcdt`(29),`col_qstgsvuago`(1));
