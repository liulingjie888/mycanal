...
RENAME
TABLE `tb_ehakozpvcb` TO `tb_qgeelwokgc`;
...
ALTER TABLE `tb_ytaiteijaz`
    ADD COLUMN `col_adlsfkuaee` set('enum_or_set_0','enum_or_set_1','enum_or_set_2') AFTER `col_vapswtjoqo`;
ALTER TABLE `tb_ytaiteijaz`
    ADD `col_ohppccpxlg` datetime NOT NULL DEFAULT '2019-07-04 00:00:00';
ALTER TABLE `tb_ytaiteijaz`
    ADD `col_wougwncovl` decimal(28, 22) NULL;
...
ALTER TABLE `tb_ytaiteijaz`
    ADD COLUMN `col_gcahrhoadr` tinyblob;
ALTER TABLE `tb_ytaiteijaz`
    ADD `col_ihtpuurapz` bit(28) AFTER `col_vapswtjoqo`;
ALTER TABLE `tb_ytaiteijaz`
    ADD COLUMN `col_agolscsuau` char(106) NULL;
ALTER TABLE `tb_ytaiteijaz`
    ADD UNIQUE KEY `col_kajgusvxkq`(`col_kajgusvxkq`,`col_wougwncovl`);
ALTER TABLE `tb_ytaiteijaz`
    ADD UNIQUE (`col_vapswtjoqo`);
ALTER TABLE `tb_ytaiteijaz`
    ALTER `col_wougwncovl` DROP DEFAULT;
