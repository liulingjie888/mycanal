...
RENAME
TABLE `tb_mfgvnrsvmu` TO `tb_psaessavwh`;
RENAME
TABLE `tb_psaessavwh` TO `tb_pgqtfhwbzc`;
RENAME
TABLE `tb_pgqtfhwbzc` TO `tb_wzvjzesyqu`;
ALTER TABLE `tb_wzvjzesyqu`
    ADD `col_gsgnhbocxa` date NOT NULL DEFAULT '2019-07-04' FIRST;
ALTER TABLE `tb_wzvjzesyqu`
    ADD `col_buaiwekzno` float DEFAULT '1' FIRST;
ALTER TABLE `tb_wzvjzesyqu` DEFAULT CHARACTER SET = utf8;
ALTER TABLE `tb_wzvjzesyqu`
    ALTER `col_nxhonchgtt` DROP DEFAULT;
ALTER TABLE `tb_wzvjzesyqu`
    ALTER COLUMN `col_gsgnhbocxa` DROP DEFAULT;
ALTER TABLE `tb_wzvjzesyqu`
    ALTER COLUMN `col_gsgnhbocxa` DROP DEFAULT;
