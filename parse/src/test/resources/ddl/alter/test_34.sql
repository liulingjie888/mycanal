...
ALTER TABLE `tb_qlkjrjqnps`
    ADD COLUMN `col_eoeroydtse` smallint(32) DEFAULT '1' FIRST;
ALTER TABLE `tb_qlkjrjqnps`
    ADD CONSTRAINT symb_rvaqwhjyyk PRIMARY KEY (`col_ktdqdryygn`, `col_vkcmtobywn`);
ALTER TABLE `tb_qlkjrjqnps`
    ALTER COLUMN `col_opbtiidusc` SET DEFAULT NULL;
ALTER TABLE `tb_qlkjrjqnps`
    ALTER `col_wgsnbmgdbz` DROP DEFAULT;
