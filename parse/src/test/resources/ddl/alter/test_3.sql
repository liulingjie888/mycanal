...
RENAME
TABLE `tb_nnvqjcjwfg` TO `tb_forjngzrrh`, `tb_meinmfimcf` TO `tb_mbjktaoecs`;
RENAME
TABLE `tb_mbjktaoecs` TO `tb_trprduwltr`, `tb_forjngzrrh` TO `tb_sdpdmvgtcg`;
...
ALTER TABLE `tb_ntoztqvpgu`
    ADD `col_yrswgxnlhe` mediumtext CHARACTER SET utf8;
...
ALTER TABLE `tb_ntoztqvpgu`
    ADD `col_aklhemsftu` datetime DEFAULT '2019-07-04 00:00:00' AFTER `col_guruxuyivx`;
