...
RENAME
TABLE `tb_ukcldpswkg` TO `tb_kifaamclft`;
RENAME
TABLE `tb_rxvmngvuko` TO `tb_jfcolfofka`;
...
ALTER TABLE `tb_tazkjnlgrx`
    ADD COLUMN `col_trhadxfbfi` numeric FIRST;
ALTER TABLE `tb_tazkjnlgrx`
    ADD COLUMN `col_jijmncnsoa` set('enum_or_set_0','enum_or_set_1','enum_or_set_2') DEFAULT 'enum_or_set_0';
ALTER TABLE `tb_tazkjnlgrx`
    ADD COLUMN `col_ucszyswhkc` bigint zerofill;
ALTER TABLE `tb_tazkjnlgrx`
    ADD COLUMN `col_fbxbftvxcl` smallint(14) zerofill;
ALTER TABLE `tb_tazkjnlgrx` ADD (`col_vbsyfqxqng` mediumblob, `col_ktnctyhcvl` blob);
ALTER TABLE `tb_tazkjnlgrx`
    ADD COLUMN `col_pbgxpvfusq` tinyblob AFTER `col_fbxbftvxcl`;
ALTER TABLE `tb_tazkjnlgrx`
    ADD COLUMN `col_ewzdxvnlrs` bit NOT NULL DEFAULT b'0' FIRST;
ALTER TABLE `tb_tazkjnlgrx`
    ADD PRIMARY KEY (`col_ewzdxvnlrs`);
ALTER TABLE `tb_tazkjnlgrx`
    ADD UNIQUE KEY `uk_ygarqhlsva` (`col_tbjrxivrjg`(5),`col_jxosxbunsc`);
