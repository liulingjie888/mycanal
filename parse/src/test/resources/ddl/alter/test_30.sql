...
RENAME
TABLE `tb_tmxzhiadaj` TO `tb_ruvaoezmwl`;
RENAME
TABLE `tb_jmcsxwqpdc` TO `tb_jchakrwydf`;
DROP TABLE tb_jchakrwydf;
ALTER TABLE `tb_pfzgcmldfg`
    ADD `col_zgrykqfrec` tinytext CHARACTER SET utf8 COLLATE utf8_unicode_ci;
ALTER TABLE `tb_pfzgcmldfg`
    ADD COLUMN `col_fpwqjmseog` numeric(12) NULL;
...
ALTER TABLE `tb_pfzgcmldfg`
    ADD PRIMARY KEY (`col_gmbaiqhote`(13), `col_lbikfetujc`);
ALTER TABLE `tb_pfzgcmldfg`
    ADD UNIQUE KEY (`col_enjwbyuifx`(20),`col_btttknjcig`(1));
ALTER TABLE `tb_pfzgcmldfg`
    ADD UNIQUE `uk_tkfeqlqmie` (`col_sqfwaxyktx`,`col_gmbaiqhote`(2));
ALTER TABLE `tb_pfzgcmldfg`
    ALTER `col_qpjwuqjymd` DROP DEFAULT;
