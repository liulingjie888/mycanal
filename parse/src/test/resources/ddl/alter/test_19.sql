...
RENAME
TABLE `tb_yubjqntjhv` TO `tb_obmtwwzsar`, `tb_gbdjlupmhj` TO `tb_acbpixrigq`;
RENAME
TABLE `tb_obmtwwzsar` TO `tb_hefguylckk`, `tb_acbpixrigq` TO `tb_nfcvlzwedu`;
DROP TABLE tb_nfcvlzwedu;
ALTER TABLE `tb_hefguylckk`
    ADD `col_hjucxhsncd` mediumint(206) unsigned zerofill;
...
ALTER TABLE `tb_hefguylckk`
    ADD UNIQUE `uk_qgxgwlyozf` (`col_fcmfyfomtk`(14));
ALTER TABLE `tb_hefguylckk`
    ADD UNIQUE INDEX (`col_bblhcpxxju`(25));
