...
RENAME
TABLE `tb_spegvrpfiz` TO `tb_lfxvmboyfq`;
ALTER TABLE `tb_lfxvmboyfq`
    ADD `col_ngeiottgyu` year(4);
ALTER TABLE `tb_lfxvmboyfq`
    ADD COLUMN `col_bvvikzmudl` bit(61);
...
ALTER TABLE `tb_lfxvmboyfq`
    ADD `col_whrxkkdwrk` tinytext;
ALTER TABLE `tb_lfxvmboyfq`
    ADD COLUMN `col_ymcntbqrwg` int zerofill FIRST;
ALTER TABLE `tb_lfxvmboyfq` ADD (`col_yxfqfnhsex` bit(43), `col_vvuposukex` numeric NOT NULL DEFAULT '1');
ALTER TABLE `tb_lfxvmboyfq`
    ADD PRIMARY KEY (`col_idrqfoikzf`);
ALTER TABLE `tb_lfxvmboyfq`
    ADD UNIQUE KEY (`col_ymcntbqrwg`);
ALTER TABLE `tb_lfxvmboyfq`
    ALTER `col_vvuposukex` SET DEFAULT '1';
