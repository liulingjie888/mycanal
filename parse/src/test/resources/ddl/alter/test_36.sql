...
RENAME
TABLE `tb_teqnorpcun` TO `tb_plmerlrvqm`;
RENAME
TABLE `tb_plmerlrvqm` TO `tb_putsugoooc`;
ALTER TABLE `tb_putsugoooc`
    ADD `col_eykecckmna` float(240,27) FIRST;
ALTER TABLE `tb_putsugoooc`
    ADD `col_anwqmnbtnq` char CHARACTER SET utf8 FIRST;
ALTER TABLE `tb_putsugoooc`
    ADD `col_zqtvmwyqye` tinyblob AFTER `col_ufqdyzbxyc`;
ALTER TABLE `tb_putsugoooc` ADD (`col_ptbaaugrfk` timestamp NULL, `col_nzheqbovze` longtext CHARACTER SET utf8mb4);
ALTER TABLE `tb_putsugoooc`
    ADD COLUMN `col_ewavlcwcvf` bigint(210) unsigned zerofill NOT NULL FIRST;
...
ALTER TABLE `tb_putsugoooc`
    ADD PRIMARY KEY (`col_ewavlcwcvf`);
