...
RENAME
TABLE `tb_lbmxsuqwfl` TO `tb_xexteouuua`, `tb_jhzyfvcckl` TO `tb_ifclwhlshu`;
RENAME
TABLE `tb_ifclwhlshu` TO `tb_kuxfqvurrv`;
RENAME
TABLE `tb_xexteouuua` TO `tb_sbjgtoodpq`;
...
ALTER TABLE `tb_sbjgtoodpq`
    ADD `col_qqyenpblbe` binary;
...
ALTER TABLE `tb_sbjgtoodpq`
    ADD UNIQUE `uk_eikmgzebja` (`col_ovkqmnppgs`(31),`col_rsjadrmlhn`(24));
ALTER TABLE `tb_sbjgtoodpq`
    ADD UNIQUE KEY `col_mkayxjoxkl`(`col_mkayxjoxkl`(27),`col_nghfeukgiz`);
ALTER TABLE `tb_sbjgtoodpq`
    ALTER COLUMN `col_qqyenpblbe` DROP DEFAULT;
ALTER TABLE `tb_sbjgtoodpq`
    ALTER COLUMN `col_zlrfenamiz` DROP DEFAULT;
