...
RENAME
TABLE `tb_lqvkbeqhuw` TO `tb_mqghelxirz`;
...
ALTER TABLE `tb_mqghelxirz`
    ADD `col_ukmsekjycj` tinyblob;
ALTER TABLE `tb_mqghelxirz`
    ADD COLUMN `col_ixaybtquqz` smallint(215) unsigned DEFAULT '1' FIRST;
...
ALTER TABLE `tb_mqghelxirz`
    ADD CONSTRAINT symb_hewywavzus PRIMARY KEY (`col_gwwjlquinc`);
ALTER TABLE `tb_mqghelxirz`
    ADD UNIQUE `col_gwwjlquinc`(`col_gwwjlquinc`,`col_gubjakxnpz`);
ALTER TABLE `tb_mqghelxirz`
    ALTER `col_rikplgqsve` SET DEFAULT NULL;
