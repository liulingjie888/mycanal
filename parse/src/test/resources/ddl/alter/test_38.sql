...
RENAME
TABLE `tb_jtxcznanun` TO `tb_djmwhfbubf`, `tb_axmikqwoki` TO `tb_unuzjkojlt`;
...
ALTER TABLE `tb_oxwwculmvu`
    ADD COLUMN `col_bewssrhuze` tinytext CHARACTER SET utf8 COLLATE utf8_unicode_ci;
ALTER TABLE `tb_oxwwculmvu`
    ADD `col_jnwlatgrgv` mediumblob FIRST;
ALTER TABLE `tb_oxwwculmvu`
    ADD COLUMN `col_xemgprlpmx` double(138,3) FIRST;
ALTER TABLE `tb_oxwwculmvu` ADD COLUMN (`col_yyixefgbqi` year(4), `col_kixpfwoyyq` tinytext CHARACTER SET utf8);
ALTER TABLE `tb_oxwwculmvu`
    ADD `col_wsgiswplbj` decimal(7, 4);
ALTER TABLE `tb_oxwwculmvu`
    ADD UNIQUE `uk_vrydxlndik` (`col_zrjuysqdco`,`col_yyixefgbqi`);
ALTER TABLE `tb_oxwwculmvu`
    ADD UNIQUE (`col_wsgiswplbj`);
ALTER TABLE `tb_oxwwculmvu`
    ALTER COLUMN `col_kesjpzxctq` DROP DEFAULT;
ALTER TABLE `tb_oxwwculmvu`
    ALTER `col_umxbmdtpxs` DROP DEFAULT;
ALTER TABLE `tb_oxwwculmvu`
    ALTER COLUMN `col_wsgiswplbj` DROP DEFAULT;
