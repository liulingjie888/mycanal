...
RENAME
TABLE `tb_ykcdymjhfs` TO `tb_dkkimqxscg`;
RENAME
TABLE `tb_dkkimqxscg` TO `tb_syxeibzqzx`;
ALTER TABLE `tb_syxeibzqzx` ADD COLUMN (`col_orgcdijcqm` numeric(50,5) NULL, `col_shntqukbsk` datetime NULL);
ALTER TABLE `tb_syxeibzqzx`
    ADD COLUMN `col_ecxangkhqi` numeric DEFAULT '1' AFTER `col_gzwherugvm`;
ALTER TABLE `tb_syxeibzqzx`
    ADD `col_nekpdybkhy` integer(53) unsigned DEFAULT '1';
...
ALTER TABLE `tb_syxeibzqzx`
    ADD UNIQUE INDEX `uk_puugjtgkjy` (`col_wfgcfbwoia`,`col_ftvwzcealb`);
