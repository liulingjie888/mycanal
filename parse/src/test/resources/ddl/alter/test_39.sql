...
RENAME
TABLE `tb_owgbdhiwmn` TO `tb_vpcgqeykeh`, `tb_xlwzxxkunf` TO `tb_xyniefhewz`;
...
ALTER TABLE `tb_aidhgjhqzp`
    ADD COLUMN `col_jsjfylwbsu` time(3) NOT NULL AFTER `col_ouqqfnoijf`;
