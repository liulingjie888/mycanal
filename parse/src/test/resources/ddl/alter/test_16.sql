...
RENAME
TABLE `tb_ddzfshecwo` TO `tb_bcsetyvuul`, `tb_baxubvrijb` TO `tb_nxbyklxowd`;
RENAME
TABLE `tb_bcsetyvuul` TO `tb_dlnhztodao`;
ALTER TABLE `tb_nxbyklxowd`
    ADD `col_zkfycwevvo` time;
...
ALTER TABLE `tb_nxbyklxowd`
    ADD COLUMN `col_crrxfxfdzs` datetime(0);
...
ALTER TABLE `tb_nxbyklxowd`
    ADD COLUMN `col_iiqainhxkc` smallint(81) zerofill NULL;
...
ALTER TABLE `tb_nxbyklxowd`
    ADD UNIQUE `col_cgdxdxesyd`(`col_cgdxdxesyd`,`col_iiqainhxkc`);
ALTER TABLE `tb_nxbyklxowd`
    ADD UNIQUE KEY `uk_regnlkocpv` (`col_zrrfkkosvo`(16),`col_fpafdojbdn`);
ALTER TABLE `tb_nxbyklxowd`
    ALTER `col_dbtkzzfxoi` DROP DEFAULT;
ALTER TABLE `tb_nxbyklxowd`
    ALTER `col_iiqainhxkc` DROP DEFAULT;
ALTER TABLE `tb_nxbyklxowd`
    ALTER `col_kcwxoovscx` DROP DEFAULT;
