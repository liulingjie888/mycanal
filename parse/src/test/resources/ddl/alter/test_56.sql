...
RENAME
TABLE `tb_lvzjcjnwfj` TO `tb_gwhtsxuovt`;
RENAME
TABLE `tb_gwhtsxuovt` TO `tb_gvuiytzqsi`;
RENAME
TABLE `tb_gvuiytzqsi` TO `tb_hjqdntirzd`;
ALTER TABLE `tb_hjqdntirzd`
    ADD COLUMN `col_oirceeozit` mediumtext AFTER `col_wfdgvtipop`;
...
ALTER TABLE `tb_hjqdntirzd`
    ADD UNIQUE KEY `uk_hrnnhxlode` (`col_urbzxvvjju`);
ALTER TABLE `tb_hjqdntirzd`
    ADD UNIQUE (`col_mwlpdcpegm`, `col_nperdtdonu`);
ALTER TABLE `tb_hjqdntirzd`
    ALTER `col_nperdtdonu` DROP DEFAULT;
