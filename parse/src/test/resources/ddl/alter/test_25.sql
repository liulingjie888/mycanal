...
RENAME
TABLE `tb_kvzhyqqpam` TO `tb_tspkdvcnhl`;
RENAME
TABLE `tb_tspkdvcnhl` TO `tb_wqjpnnzouv`;
RENAME
TABLE `tb_wqjpnnzouv` TO `tb_aafdasghga`;
...
ALTER TABLE `tb_aafdasghga`
    ADD `col_ixseptopfk` date DEFAULT '2019-07-04';
ALTER TABLE `tb_aafdasghga`
    ADD `col_pslvsvljbg` longblob;
ALTER TABLE `tb_aafdasghga`
    ADD COLUMN `col_ispobmxiik` year;
...
ALTER TABLE `tb_aafdasghga`
    ADD UNIQUE (`col_fxicikwsct`, `col_spzdmnayxy`(21));
ALTER TABLE `tb_aafdasghga`
    ADD UNIQUE (`col_zbenqlvted`, `col_pslvsvljbg`(10));
