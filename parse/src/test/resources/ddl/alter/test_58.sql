...
RENAME
TABLE `tb_ezaysnxloa` TO `tb_wsxpqlbxhr`;
...
ALTER TABLE `tb_wsxpqlbxhr`
    ADD `col_btyjfvfohb` double(18,12);
...
ALTER TABLE `tb_wsxpqlbxhr`
    ADD COLUMN `col_kkdtlacxiy` char NOT NULL FIRST;
ALTER TABLE `tb_wsxpqlbxhr`
    ADD `col_xlcidwqtlg` tinytext CHARACTER SET utf8;
ALTER TABLE `tb_wsxpqlbxhr` ADD COLUMN (`col_huxsdgntaw` numeric(27,14) NOT NULL, `col_siklbsrsfa` date NOT NULL);
ALTER TABLE `tb_wsxpqlbxhr`
    ADD PRIMARY KEY (`col_kkdtlacxiy`, `col_huxsdgntaw`);
ALTER TABLE `tb_wsxpqlbxhr`
    ADD UNIQUE INDEX `uk_cpzrxvccoo` (`col_nacwazcyzi`(7),`col_xlcidwqtlg`(9));
