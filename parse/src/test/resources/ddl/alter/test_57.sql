...
RENAME
TABLE `tb_okrocudiku` TO `tb_bozkivuenk`, `tb_fvjncpgwhy` TO `tb_cegumineka`;
RENAME
TABLE `tb_cegumineka` TO `tb_xmvawoekwx`;
DROP TABLE tb_bozkivuenk;
ALTER TABLE `tb_xmvawoekwx`
    ADD COLUMN `col_jzpxlsfskd` varbinary(49) DEFAULT '\0' FIRST;
ALTER TABLE `tb_xmvawoekwx` CHARACTER SET utf8mb4;
ALTER TABLE `tb_xmvawoekwx`
    ADD UNIQUE INDEX `uk_gkkpkxazqo` (`col_yeejeykwvz`(18),`col_icjtmriski`(2));
ALTER TABLE `tb_xmvawoekwx`
    ADD UNIQUE INDEX `uk_sgrofvqufp` (`col_yeejeykwvz`(32),`col_icjtmriski`(2));
