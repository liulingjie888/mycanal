...
RENAME
TABLE `tb_zeqwdifiwa` TO `tb_mwiswycksv`;
RENAME
TABLE `tb_mwiswycksv` TO `tb_kzlrbhxfpu`;
DROP TABLE tb_pektpgbgcx, tb_kzlrbhxfpu;
ALTER TABLE `tb_vyhepkdocw`
    ADD `col_chvhleyulg` tinytext;
ALTER TABLE `tb_vyhepkdocw`
    ADD COLUMN `col_onhyboljxa` date NULL AFTER `col_lvqcegncth`;
ALTER TABLE `tb_vyhepkdocw` ADD (`col_getqnnhjry` date NULL, `col_dlomfzxpjh` mediumblob);
ALTER TABLE `tb_vyhepkdocw`
    ADD COLUMN `col_ahjuyzjbhk` bit AFTER `col_getqnnhjry`;
...
ALTER TABLE `tb_vyhepkdocw`
    ADD UNIQUE `col_daemlskcfa`(`col_onhyboljxa`,`col_slupqsxneh`);
