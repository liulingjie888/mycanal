...
RENAME
TABLE `tb_uakpdqzysm` TO `tb_btqvbuxdyv`, `tb_vktpftxscc` TO `tb_fficunfgca`;
DROP TABLE tb_fficunfgca;
ALTER TABLE `tb_sxbbqclsgf`
    ADD `col_glgspzmrxu` mediumint zerofill NOT NULL AFTER `col_avzjcdfkfv`;
...
ALTER TABLE `tb_sxbbqclsgf`
    ADD COLUMN `col_tekylcrmef` bit(17) NULL DEFAULT b'0';
ALTER TABLE `tb_sxbbqclsgf`
    ADD COLUMN `col_ukcpwepvny` timestamp(1) DEFAULT CURRENT_TIMESTAMP(1) FIRST;
ALTER TABLE `tb_sxbbqclsgf` DEFAULT CHARACTER SET utf8;
ALTER TABLE `tb_sxbbqclsgf`
    ADD UNIQUE `uk_htumixicdh` (`col_avzjcdfkfv`,`col_kgfprqgdwt`(28));
ALTER TABLE `tb_sxbbqclsgf`
    ALTER COLUMN `col_nmxcrltjbv` SET DEFAULT NULL;
