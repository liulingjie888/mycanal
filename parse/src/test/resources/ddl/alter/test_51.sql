...
RENAME
TABLE `tb_bfwanxinyr` TO `tb_wvhiikgeky`;
RENAME
TABLE `tb_wvhiikgeky` TO `tb_krsikytrbw`;
...
ALTER TABLE `tb_krsikytrbw`
    ADD COLUMN `col_lnpeucimig` time NOT NULL DEFAULT '00:00:00';
ALTER TABLE `tb_krsikytrbw`
    ADD `col_idovrewllo` tinytext FIRST;
ALTER TABLE `tb_krsikytrbw`
    ADD `col_szvdshblvc` tinyint(109) unsigned zerofill;
ALTER TABLE `tb_krsikytrbw`
    ADD COLUMN `col_qgtkapnaff` blob(2990008429);
ALTER TABLE `tb_krsikytrbw`
    ADD CONSTRAINT symb_kcuznajfjp PRIMARY KEY (`col_cqjptjcgyb`);
ALTER TABLE `tb_krsikytrbw`
    ADD UNIQUE (`col_qgtkapnaff`(16));
ALTER TABLE `tb_krsikytrbw`
    ADD UNIQUE INDEX (`col_cqjptjcgyb`,`col_szvdshblvc`);
ALTER TABLE `tb_krsikytrbw`
    ALTER `col_eystskhwfm` DROP DEFAULT;
ALTER TABLE `tb_krsikytrbw`
    ALTER COLUMN `col_cqjptjcgyb` DROP DEFAULT;
ALTER TABLE `tb_krsikytrbw`
    ALTER COLUMN `col_lnpeucimig` SET DEFAULT '00:00:00';
