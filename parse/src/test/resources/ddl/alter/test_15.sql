...
RENAME
TABLE `tb_odalwcctzo` TO `tb_hgbecqwvnf`, `tb_ypebrnimav` TO `tb_dqeiczpcpp`;
...
ALTER TABLE `tb_hgbecqwvnf`
    ADD COLUMN `col_nyrvlflfiz` mediumblob FIRST;
ALTER TABLE `tb_hgbecqwvnf`
    ADD COLUMN `col_cdafuglmqd` mediumblob AFTER `col_ocmmfdzihr`;
ALTER TABLE `tb_hgbecqwvnf` ADD (`col_ibpfuqwtka` integer(152) zerofill NOT NULL, `col_mfbftkexwt` time(4) NULL);
ALTER TABLE `tb_hgbecqwvnf`
    ADD `col_rfnetihhhs` numeric(15) NOT NULL AFTER `col_ibpfuqwtka`;
ALTER TABLE `tb_hgbecqwvnf`
    ADD `col_shfhtlxxhg` bigint unsigned zerofill;
...
ALTER TABLE `tb_hgbecqwvnf`
    ADD CONSTRAINT symb_vxlhuityyt PRIMARY KEY (`col_iomejxwfzh`);
ALTER TABLE `tb_hgbecqwvnf`
    ADD UNIQUE `uk_lsuitvpjev` (`col_iomejxwfzh`,`col_dqpoxmoyzl`);
ALTER TABLE `tb_hgbecqwvnf`
    ADD UNIQUE `col_luknerkzbg`(`col_luknerkzbg`,`col_dqpoxmoyzl`);
ALTER TABLE `tb_hgbecqwvnf`
    ALTER `col_rfnetihhhs` DROP DEFAULT;
ALTER TABLE `tb_hgbecqwvnf`
    ALTER COLUMN `col_dqpoxmoyzl` SET DEFAULT '1';
