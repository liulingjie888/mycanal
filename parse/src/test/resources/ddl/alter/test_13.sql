...
RENAME
TABLE `tb_vqlldbakax` TO `tb_xduxzgfsux`;
RENAME
TABLE `tb_xduxzgfsux` TO `tb_yfhnotrnrt`;
...
ALTER TABLE `tb_yfhnotrnrt`
    ADD COLUMN `col_iruzsjhmbm` varbinary(83) DEFAULT '\0';
ALTER TABLE `tb_yfhnotrnrt` CHARACTER SET utf8;
ALTER TABLE `tb_yfhnotrnrt`
    ALTER COLUMN `col_iruzsjhmbm` DROP DEFAULT;
ALTER TABLE `tb_yfhnotrnrt`
    ALTER COLUMN `col_ormwjqfbxi` SET DEFAULT NULL;
ALTER TABLE `tb_yfhnotrnrt`
    ALTER COLUMN `col_xgueitftmx` DROP DEFAULT;
