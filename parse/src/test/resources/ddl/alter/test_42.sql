...
RENAME
TABLE `tb_ofxsxmoixc` TO `tb_mriknxonls`;
RENAME
TABLE `tb_mriknxonls` TO `tb_hkehwyglax`;
ALTER TABLE `tb_hkehwyglax`
    ADD `col_hpedrlkbit` tinyblob FIRST;
ALTER TABLE `tb_hkehwyglax` ADD (`col_aftchdhhpb` integer unsigned NULL, `col_engwamylfv` text);
ALTER TABLE `tb_hkehwyglax`
    ADD `col_dcnadmyyfb` binary FIRST;
ALTER TABLE `tb_hkehwyglax` ADD COLUMN (`col_epoaxrbmcm` double NOT NULL, `col_qknitkqdnz` longblob);
ALTER TABLE `tb_hkehwyglax`
    ADD COLUMN `col_upulxkgdxc` bigint;
...
ALTER TABLE `tb_hkehwyglax`
    ADD CONSTRAINT PRIMARY KEY (`col_epoaxrbmcm`);
ALTER TABLE `tb_hkehwyglax`
    ADD UNIQUE KEY `uk_tkjaqutxko` (`col_yxsvpkijew`);
ALTER TABLE `tb_hkehwyglax`
    ADD UNIQUE (`col_tymnumzsjd`(17), `col_aftchdhhpb`);
