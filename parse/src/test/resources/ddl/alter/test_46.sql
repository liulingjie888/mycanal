...
RENAME
TABLE `tb_nkikxbvhfw` TO `tb_cihgbeacba`, `tb_zbnbjecfad` TO `tb_mlsrpqwnhf`;
DROP TABLE tb_cihgbeacba;
ALTER TABLE `tb_mlsrpqwnhf`
    ADD COLUMN `col_mfdevzanga` tinyint zerofill NOT NULL;
ALTER TABLE `tb_mlsrpqwnhf`
    ADD COLUMN `col_yualkpafem` double(197,7);
ALTER TABLE `tb_mlsrpqwnhf` ADD (`col_cmghpeldvl` mediumtext CHARACTER SET utf8, `col_ooogllngga` decimal(38,8) NULL);
ALTER TABLE `tb_mlsrpqwnhf`
    ADD `col_fkklsgzldp` numeric NOT NULL;
...
ALTER TABLE `tb_mlsrpqwnhf`
    ADD CONSTRAINT PRIMARY KEY (`col_hiezvpgyuu`);
ALTER TABLE `tb_mlsrpqwnhf`
    ADD UNIQUE INDEX `uk_jybutmebnj` (`col_fkklsgzldp`,`col_yeligvvmhm`(2));
ALTER TABLE `tb_mlsrpqwnhf`
    ALTER `col_ovrngczyyk` DROP DEFAULT;
ALTER TABLE `tb_mlsrpqwnhf`
    ALTER COLUMN `col_mfdevzanga` DROP DEFAULT;
