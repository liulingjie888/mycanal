...
RENAME
TABLE `tb_ucmkmerovj` TO `tb_spnawqlyqo`, `tb_nsjknrezjn` TO `tb_ezrzlemqcq`;
RENAME
TABLE `tb_spnawqlyqo` TO `tb_wbbrvurmym`;
...
ALTER TABLE `tb_odwnejztgw`
    ADD COLUMN `col_dqxacqwdav` year NULL;
ALTER TABLE `tb_odwnejztgw`
    ADD COLUMN `col_afisennniu` enum('enum_or_set_0','enum_or_set_1','enum_or_set_2') NOT NULL DEFAULT 'enum_or_set_0';
ALTER TABLE `tb_odwnejztgw`
    ADD COLUMN `col_ikgmyfugbh` time(3) FIRST;
...
ALTER TABLE `tb_odwnejztgw`
    ADD `col_hxgvemyiam` tinytext CHARACTER SET utf8;
ALTER TABLE `tb_odwnejztgw`
    ADD COLUMN `col_ouwtrbmtli` varbinary(39) NULL DEFAULT '\0' FIRST;
ALTER TABLE `tb_odwnejztgw` DEFAULT CHARACTER SET = utf8;
ALTER TABLE `tb_odwnejztgw`
    ADD CONSTRAINT symb_pztcjvefkb PRIMARY KEY (`col_afisennniu`);
