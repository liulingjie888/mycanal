...
RENAME
TABLE `tb_kcqprbgueu` TO `tb_vsurmlbmno`;
RENAME
TABLE `tb_vsurmlbmno` TO `tb_aaholafery`;
RENAME
TABLE `tb_aaholafery` TO `tb_mjvfhaqskb`;
ALTER TABLE `tb_mjvfhaqskb`
    ADD `col_njoaqbbtxv` bit(26) DEFAULT b'0';
ALTER TABLE `tb_mjvfhaqskb`
    ADD COLUMN `col_mipvhqbjat` mediumtext CHARACTER SET utf8 AFTER `col_zzurkpmmun`;
ALTER TABLE `tb_mjvfhaqskb`
    ADD COLUMN `col_bjzwkjcmer` decimal(17, 10) FIRST;
ALTER TABLE `tb_mjvfhaqskb` ADD COLUMN (`col_qnkieomtxh` datetime(5), `col_olvjbrfhvy` char NULL);
ALTER TABLE `tb_mjvfhaqskb`
    ADD `col_bnupaoxxfv` blob(1570619016) AFTER `col_qnkieomtxh`;
ALTER TABLE `tb_mjvfhaqskb`
    ADD UNIQUE `uk_sidczmsazr` (`col_bkngorvqcs`(6),`col_mipvhqbjat`(25));
ALTER TABLE `tb_mjvfhaqskb`
    ALTER COLUMN `col_zzurkpmmun` DROP DEFAULT;
