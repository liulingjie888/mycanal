...
RENAME
TABLE `tb_wbajtotdth` TO `tb_bxtlrumrtn`, `tb_vrtkbtmnws` TO `tb_irclltefag`;
ALTER TABLE `tb_bxtlrumrtn` CHARACTER SET = utf8mb4;
ALTER TABLE `tb_bxtlrumrtn`
    ALTER `col_nhckjelmwe` DROP DEFAULT;
ALTER TABLE `tb_bxtlrumrtn`
    ALTER `col_uttbttlgkx` SET DEFAULT NULL;
