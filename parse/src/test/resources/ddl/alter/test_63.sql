...
RENAME
TABLE `tb_rabcferkcm` TO `tb_ayfynftwmh`;
RENAME
TABLE `tb_ayfynftwmh` TO `tb_eufiooviox`;
RENAME
TABLE `tb_eufiooviox` TO `tb_txslclddib`;
...
ALTER TABLE `tb_txslclddib`
    ADD `col_yvgymfxalr` year NULL DEFAULT '2019' AFTER `col_fflqfgfdyt`;
...
ALTER TABLE `tb_txslclddib`
    ADD COLUMN `col_lzgdrufqst` blob(2902581366) AFTER `col_gileulcldv`;
ALTER TABLE `tb_txslclddib` ADD COLUMN (`col_outygtpgyl` numeric(49) NULL, `col_wdxmmljumj` numeric(35));
ALTER TABLE `tb_txslclddib`
    ADD `col_whoyzvbsui` binary(117) FIRST;
ALTER TABLE `tb_txslclddib`
    ADD `col_pphxdgjxqs` timestamp;
ALTER TABLE `tb_txslclddib`
    ADD UNIQUE INDEX (`col_zssozexdev`(11),`col_qjmexurrhz`(14));
ALTER TABLE `tb_txslclddib`
    ADD UNIQUE INDEX `uk_uvxmxuhrsq` (`col_wdxmmljumj`,`col_pphxdgjxqs`);
ALTER TABLE `tb_txslclddib`
    ALTER `col_outygtpgyl` DROP DEFAULT;
