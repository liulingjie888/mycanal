...
RENAME
TABLE `tb_ijmcdmzknr` TO `tb_mzqlybwqbo`;
RENAME
TABLE `tb_mzqlybwqbo` TO `tb_gnbqbndsaw`;
ALTER TABLE `tb_gnbqbndsaw` ADD (`col_gpjsqkkxse` integer unsigned NULL DEFAULT '1', `col_gmjtupvuvl` text(644744023));
ALTER TABLE `tb_gnbqbndsaw`
    ADD UNIQUE INDEX `uk_cbwijpiehr` (`col_pqnfhpfywv`,`col_gpjsqkkxse`);
ALTER TABLE `tb_gnbqbndsaw`
    ADD UNIQUE (`col_mlpkfxnbfa`(18));
