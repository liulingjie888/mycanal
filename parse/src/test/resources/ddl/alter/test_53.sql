...
RENAME
TABLE `tb_gphkzjggwo` TO `tb_swbjpgvwuf`;
RENAME
TABLE `tb_swbjpgvwuf` TO `tb_hdbseivabf`;
RENAME
TABLE `tb_kfmwkcront` TO `tb_mnqvagcyml`, `tb_hdbseivabf` TO `tb_eswbmodety`;
...
ALTER TABLE `tb_gcekkribdm`
    ADD COLUMN `col_doacvjtxfj` text FIRST;
ALTER TABLE `tb_gcekkribdm` ADD (`col_xpwlcesvfx` integer(73), `col_inpipqloqk` smallint zerofill NULL);
ALTER TABLE `tb_gcekkribdm`
    ADD `col_kahmeuqzzo` mediumtext CHARACTER SET utf8mb4 AFTER `col_hmbydpntpk`;
ALTER TABLE `tb_gcekkribdm`
    ADD COLUMN `col_xpuntwyhls` int(253) zerofill FIRST;
