...
RENAME
TABLE `tb_hovvshypke` TO `tb_zixkylluol`, `tb_tfimbaoajc` TO `tb_rmmpcdzkft`;
ALTER TABLE `tb_zixkylluol`
    ADD COLUMN `col_iwtkwazsiv` time NULL DEFAULT '00:00:00' AFTER `col_psutzipcit`;
ALTER TABLE `tb_zixkylluol`
    ADD COLUMN `col_cqbtbuqstu` smallint unsigned;
ALTER TABLE `tb_zixkylluol` DEFAULT CHARACTER SET utf8mb4;
ALTER TABLE `tb_zixkylluol`
    ALTER COLUMN `col_psutzipcit` DROP DEFAULT;
ALTER TABLE `tb_zixkylluol`
    ALTER `col_psutzipcit` DROP DEFAULT;
