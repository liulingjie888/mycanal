...
RENAME
TABLE `tb_zjdvakwwwv` TO `tb_unztlaanoa`;
RENAME
TABLE `tb_unztlaanoa` TO `tb_wxywfqcvkr`;
...
ALTER TABLE `tb_wxywfqcvkr`
    ADD COLUMN `col_vjvhvsxmoi` bigint zerofill AFTER `col_desbhtchpe`;
ALTER TABLE `tb_wxywfqcvkr` ADD COLUMN (`col_whowxgsfzl` blob(1844532465), `col_mzdqafxiqx` bigint(161) unsigned DEFAULT '1');
ALTER TABLE `tb_wxywfqcvkr`
    ADD `col_spyfsutunk` bit DEFAULT b'0' AFTER `col_zwyhucxxkr`;
ALTER TABLE `tb_wxywfqcvkr`
    ADD `col_iqugcuomsl` numeric(9) NOT NULL;
ALTER TABLE `tb_wxywfqcvkr`
    ADD PRIMARY KEY (`col_zwyhucxxkr`, `col_adpuaqjrtd`);
