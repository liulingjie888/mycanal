...
RENAME
TABLE `tb_axknhurptj` TO `tb_iilujirnjb`;
RENAME
TABLE `tb_iilujirnjb` TO `tb_aftfwefuwe`;
...
ALTER TABLE `tb_ygyyvdctrs`
    ADD COLUMN `col_ljhqsygrcc` mediumtext FIRST;
...
ALTER TABLE `tb_ygyyvdctrs`
    ADD `col_oxgbfbgzov` double(112,2);
ALTER TABLE `tb_ygyyvdctrs`
    ADD COLUMN `col_hirzxaomit` varbinary(145) NOT NULL FIRST;
ALTER TABLE `tb_ygyyvdctrs`
    ADD COLUMN `col_dxgsghrizm` tinyblob;
ALTER TABLE `tb_ygyyvdctrs`
    ADD `col_zkdwjtabnw` smallint unsigned NOT NULL AFTER `col_oxgbfbgzov`;
...
ALTER TABLE `tb_ygyyvdctrs`
    ADD CONSTRAINT PRIMARY KEY (`col_hirzxaomit`(25));
ALTER TABLE `tb_ygyyvdctrs`
    ALTER COLUMN `col_ibmogxgtyp` DROP DEFAULT;
ALTER TABLE `tb_ygyyvdctrs`
    ALTER COLUMN `col_hirzxaomit` DROP DEFAULT;
ALTER TABLE `tb_ygyyvdctrs`
    ALTER COLUMN `col_ibmogxgtyp` SET DEFAULT 'enum_or_set_0';
