...
RENAME
TABLE `tb_walklosuks` TO `tb_mkeptukxss`;
RENAME
TABLE `tb_mkeptukxss` TO `tb_sqndbrgkvj`;
ALTER TABLE `tb_sqndbrgkvj` ADD (`col_xuafealoty` float, `col_durclethxo` smallint);
ALTER TABLE `tb_sqndbrgkvj`
    ADD `col_plylqkvjll` time(5);
ALTER TABLE `tb_sqndbrgkvj`
    ADD COLUMN `col_erbwiiktwe` integer zerofill NULL FIRST;
...
ALTER TABLE `tb_sqndbrgkvj`
    ADD `col_mueqvldinf` integer unsigned DEFAULT '1' FIRST;
ALTER TABLE `tb_sqndbrgkvj`
    ADD `col_prvruzvlqp` set('enum_or_set_0','enum_or_set_1','enum_or_set_2') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL;
ALTER TABLE `tb_sqndbrgkvj`
    ADD COLUMN `col_bujrefmxrj` bit(35) AFTER `col_xuafealoty`;
ALTER TABLE `tb_sqndbrgkvj` CHARACTER SET utf8mb4;
ALTER TABLE `tb_sqndbrgkvj`
    ADD CONSTRAINT symb_uyzanxlotu PRIMARY KEY (`col_prvruzvlqp`);
ALTER TABLE `tb_sqndbrgkvj`
    ADD UNIQUE INDEX (`col_plylqkvjll`,`col_pymdrmukax`);
ALTER TABLE `tb_sqndbrgkvj`
    ADD UNIQUE KEY `col_rtbkufevvv`(`col_rtbkufevvv`,`col_bujrefmxrj`);
