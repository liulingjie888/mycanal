...
RENAME
TABLE `tb_xuylcctytd` TO `tb_mvpbukrobp`;
ALTER TABLE `tb_mvpbukrobp`
    ADD COLUMN `col_gepoechcst` char;
...
ALTER TABLE `tb_mvpbukrobp`
    ADD `col_ivdmwufhla` bit NULL DEFAULT b'0';
...
ALTER TABLE `tb_mvpbukrobp`
    ADD `col_fjxdpmowuy` mediumtext CHARACTER SET utf8mb4;
ALTER TABLE `tb_mvpbukrobp`
    ADD UNIQUE `uk_ckopkpiarf` (`col_oxgdbldyfk`,`col_sfpolurvqu`);
ALTER TABLE `tb_mvpbukrobp`
    ADD UNIQUE KEY `uk_nqultcfeau` (`col_ivdmwufhla`,`col_vpymqtoibu`(19));
