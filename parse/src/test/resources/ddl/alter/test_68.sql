...
RENAME
TABLE `tb_xyqwqnvfml` TO `tb_gfcldozzsj`;
DROP TABLE tb_gfcldozzsj, tb_febzciaoij;
ALTER TABLE `tb_vmghxdnngw`
    ADD `col_mhpxueotyg` year(4) NULL FIRST;
...
ALTER TABLE `tb_vmghxdnngw`
    ALTER COLUMN `col_xwdguyhvwy` SET DEFAULT b'0';
ALTER TABLE `tb_vmghxdnngw`
    ALTER `col_mhpxueotyg` DROP DEFAULT;
