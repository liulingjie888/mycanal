...
RENAME
TABLE `tb_iuqrkykntm` TO `tb_gwhacmapbj`;
RENAME
TABLE `tb_gwhacmapbj` TO `tb_havvvaohnr`;
RENAME
TABLE `tb_havvvaohnr` TO `tb_nduadhjfex`;
...
ALTER TABLE `tb_tilukdjjhc`
    ADD `col_fgidnnqvqm` year NOT NULL;
ALTER TABLE `tb_tilukdjjhc`
    ADD COLUMN `col_loxvzbzvge` char CHARACTER SET utf8 NULL AFTER `col_kxelvjyosf`;
ALTER TABLE `tb_tilukdjjhc` ADD COLUMN (`col_uzxvkpgggz` mediumblob, `col_gqssffnbgo` tinyblob);
ALTER TABLE `tb_tilukdjjhc`
    ADD `col_jtyftybbku` decimal(13, 5) NOT NULL AFTER `col_uzxvkpgggz`;
ALTER TABLE `tb_tilukdjjhc`
    ADD COLUMN `col_drlfahzqxk` datetime(4) NOT NULL;
ALTER TABLE `tb_tilukdjjhc` ADD (`col_bzzxemkcuj` double, `col_olnmovdyfw` bit(3) NULL DEFAULT b'0');
ALTER TABLE `tb_tilukdjjhc`
    ADD COLUMN `col_avfiwopsik` float;
ALTER TABLE `tb_tilukdjjhc` DEFAULT CHARACTER SET utf8mb4;
ALTER TABLE `tb_tilukdjjhc`
    ALTER COLUMN `col_bzzxemkcuj` DROP DEFAULT;
