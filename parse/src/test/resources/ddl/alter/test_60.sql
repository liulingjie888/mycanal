...
RENAME
TABLE `tb_zsvasnztbf` TO `tb_sxhjnreyoa`, `tb_joibqmiluh` TO `tb_qlhhbdmoeq`;
RENAME
TABLE `tb_sxhjnreyoa` TO `tb_idttivasrc`, `tb_qlhhbdmoeq` TO `tb_rjdimmicei`;
ALTER TABLE `tb_idttivasrc` ADD (`col_qgehaatedk` tinyint unsigned zerofill NOT NULL, `col_ngqfbkxgkw` tinyblob);
ALTER TABLE `tb_idttivasrc`
    ADD `col_naimzyvtyy` mediumint unsigned AFTER `col_qgehaatedk`;
ALTER TABLE `tb_idttivasrc`
    ADD COLUMN `col_ybyyrfaujt` longtext;
...
ALTER TABLE `tb_idttivasrc`
    ALTER COLUMN `col_rjrhithgjd` DROP DEFAULT;
