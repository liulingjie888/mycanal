...
RENAME
TABLE `tb_mfkmsjoicz` TO `tb_cqcpkwgqnw`;
RENAME
TABLE `tb_cqcpkwgqnw` TO `tb_wqthgwmnob`;
ALTER TABLE `tb_wqthgwmnob`
    ADD `col_ekbblvxoft` longblob;
ALTER TABLE `tb_wqthgwmnob`
    ADD COLUMN `col_lgwmegdicv` date NULL DEFAULT '2019-07-04';
