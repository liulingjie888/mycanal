...
RENAME
TABLE `tb_cfbrttmxtt` TO `tb_fzlrvzctbr`;
RENAME
TABLE `tb_ibnzwrlofl` TO `tb_tmasbkkzbt`;
RENAME
TABLE `tb_qhfiwjigtv` TO `tb_vnbuhzbwvw`;
ALTER TABLE `tb_tmasbkkzbt`
    ADD COLUMN `col_gvdetvdvvm` text(3429904651);
ALTER TABLE `tb_tmasbkkzbt`
    ADD UNIQUE `uk_dvgbfwphsv` (`col_gvdetvdvvm`(27));
ALTER TABLE `tb_tmasbkkzbt`
    ALTER `col_ektspnhakb` SET DEFAULT NULL;
