...
RENAME
TABLE `tb_jkbiibupis` TO `tb_epubreeayc`, `tb_pqjlitgelb` TO `tb_uafierhjhg`;
ALTER TABLE `tb_epubreeayc`
    ADD COLUMN `col_eznnzdmtjb` blob(2459218563) AFTER `col_gfzhcaruwf`;
ALTER TABLE `tb_epubreeayc`
    ADD `col_orujerqezb` enum('enum_or_set_0','enum_or_set_1','enum_or_set_2') CHARACTER SET utf8mb4;
...
ALTER TABLE `tb_epubreeayc`
    ADD `col_vkrzrlbckh` binary AFTER `col_embnqthyuu`;
ALTER TABLE `tb_epubreeayc`
    ADD COLUMN `col_aqvohzuvxd` set('enum_or_set_0','enum_or_set_1','enum_or_set_2') CHARACTER SET utf8mb4 NOT NULL;
...
ALTER TABLE `tb_epubreeayc`
    ADD PRIMARY KEY (`col_embnqthyuu`);
ALTER TABLE `tb_epubreeayc`
    ADD UNIQUE `uk_uydztaglgb` (`col_aqvohzuvxd`,`col_aexcfuzeln`);
