...
RENAME
TABLE `tb_fyextrfwrp` TO `tb_mdvjbvmscg`;
RENAME
TABLE `tb_mdvjbvmscg` TO `tb_kzznkaskgu`;
RENAME
TABLE `tb_kzznkaskgu` TO `tb_cvpyawneqw`;
ALTER TABLE `tb_cvpyawneqw` ADD (`col_klkrbtckkp` varchar(114) NULL, `col_yfpelqlubr` bigint(252) unsigned zerofill NULL);
ALTER TABLE `tb_cvpyawneqw`
    ADD `col_gxyxiafdwy` tinyblob;
ALTER TABLE `tb_cvpyawneqw` ADD COLUMN (`col_spugbpzyyf` double NOT NULL, `col_wbsqhinkwg` text);
ALTER TABLE `tb_cvpyawneqw`
    ADD COLUMN `col_npeyxvumaf` numeric(23) NULL AFTER `col_klkrbtckkp`;
ALTER TABLE `tb_cvpyawneqw` ADD COLUMN (`col_jrdtjutkna` int unsigned, `col_geplpeokit` smallint);
ALTER TABLE `tb_cvpyawneqw`
    ADD UNIQUE `uk_ameijmmzqx` (`col_sowlpsmtck`(21),`col_nnggkdrfej`);
ALTER TABLE `tb_cvpyawneqw`
    ADD UNIQUE (`col_gxyxiafdwy`(28), `col_spugbpzyyf`);
ALTER TABLE `tb_cvpyawneqw`
    ALTER `col_yzwppisdla` SET DEFAULT 'enum_or_set_0';
