...
RENAME
TABLE `tb_dkdeujiqjf` TO `tb_ehfacgfjnk`;
RENAME
TABLE `tb_ehfacgfjnk` TO `tb_zwzsaathnd`;
ALTER TABLE `tb_zwzsaathnd`
    ADD COLUMN `col_axigbojqvl` float(34);
...
ALTER TABLE `tb_zwzsaathnd`
    ADD `col_ojaoqduwkj` date DEFAULT '2019-07-04' FIRST;
ALTER TABLE `tb_zwzsaathnd`
    ADD `col_rqumywduzu` time FIRST;
ALTER TABLE `tb_zwzsaathnd`
    ADD `col_xxmdywhgie` mediumint NULL;
ALTER TABLE `tb_zwzsaathnd` CHARACTER SET = utf8;
ALTER TABLE `tb_zwzsaathnd`
    ADD UNIQUE KEY `col_rqumywduzu`(`col_rqumywduzu`,`col_ojaoqduwkj`);
ALTER TABLE `tb_zwzsaathnd`
    ADD UNIQUE INDEX `col_dseumehqur`(`col_dseumehqur`(21),`col_xxmdywhgie`);
ALTER TABLE `tb_zwzsaathnd`
    ALTER COLUMN `col_rxmvdbomhz` SET DEFAULT NULL;
