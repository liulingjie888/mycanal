...
RENAME
TABLE `tb_efrfggoljv` TO `tb_lznvphwjai`, `tb_wumnowgbgm` TO `tb_vinehxgnxe`;
...
ALTER TABLE `tb_mpjfjmkbwn`
    ADD `col_eyzpohpkcl` integer zerofill NOT NULL AFTER `col_lyrrpdesag`;
...
ALTER TABLE `tb_mpjfjmkbwn`
    ADD COLUMN `col_ximpbczbvl` longblob FIRST;
