...
RENAME
TABLE `tb_fwnltgnpeg` TO `tb_hmfoniytbf`;
ALTER TABLE `tb_hmfoniytbf`
    ADD COLUMN `col_gxqvwbkvyi` datetime(5);
ALTER TABLE `tb_hmfoniytbf` ADD COLUMN (`col_fthqvynbuq` mediumint unsigned zerofill, `col_dcxnatwddd` date DEFAULT '2019-07-04');
ALTER TABLE `tb_hmfoniytbf`
    ADD COLUMN `col_wvbemkrzdt` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci FIRST;
ALTER TABLE `tb_hmfoniytbf`
    ADD `col_alzezpawqi` longblob;
ALTER TABLE `tb_hmfoniytbf`
    ADD COLUMN `col_tpzhsbkmka` longtext;
...
ALTER TABLE `tb_hmfoniytbf`
    ADD UNIQUE INDEX `uk_ztdbxlchxi` (`col_alzezpawqi`(18),`col_tpzhsbkmka`(30));
ALTER TABLE `tb_hmfoniytbf`
    ALTER COLUMN `col_dcxnatwddd` DROP DEFAULT;
