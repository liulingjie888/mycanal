...
RENAME
TABLE `tb_fbpivvptsa` TO `tb_rtvtzkfcfx`;
RENAME
TABLE `tb_rtvtzkfcfx` TO `tb_cockfzvkou`;
ALTER TABLE `tb_cockfzvkou`
    ADD `col_unrdwzfczo` tinyblob AFTER `col_hbauqbdefn`;
ALTER TABLE `tb_cockfzvkou` CHARACTER SET = utf8;
ALTER TABLE `tb_cockfzvkou`
    ADD UNIQUE (`col_hbauqbdefn`, `col_unrdwzfczo`(7));
ALTER TABLE `tb_cockfzvkou`
    ADD UNIQUE (`col_hbauqbdefn`);
