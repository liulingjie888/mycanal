...
RENAME
TABLE `tb_tbfvbntpjg` TO `tb_rhtejtaerv`;
RENAME
TABLE `tb_pksakrzcnn` TO `tb_cfnewnjqhr`, `tb_rhtejtaerv` TO `tb_naclwnujgs`;
...
ALTER TABLE `tb_cfnewnjqhr`
    ADD UNIQUE (`col_gtrcjlfnjb`(11), `col_efozqsfkcb`);
