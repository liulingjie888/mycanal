...
RENAME
TABLE `tb_ajxoovpkvw` TO `tb_qlvbveqzna`, `tb_yntgfjruqk` TO `tb_eegcnsbywv`;
ALTER TABLE `tb_eegcnsbywv` ADD (`col_jophiowutg` longtext, `col_pnotecfjsi` decimal);
ALTER TABLE `tb_eegcnsbywv`
    ADD `col_eawvokgzvi` year(4) NOT NULL DEFAULT '2019';
ALTER TABLE `tb_eegcnsbywv`
    ADD `col_orlvhbnaer` longtext CHARACTER SET utf8mb4;
...
ALTER TABLE `tb_eegcnsbywv`
    ADD `col_trrvagfhxb` longblob AFTER `col_uuexgtwrse`;
ALTER TABLE `tb_eegcnsbywv` ADD (`col_hfrmqomgva` date, `col_mepqygbcxa` text CHARACTER SET utf8mb4);
ALTER TABLE `tb_eegcnsbywv`
    ADD `col_xmubzkmxzy` mediumblob;
ALTER TABLE `tb_eegcnsbywv` DEFAULT CHARACTER SET = utf8;
ALTER TABLE `tb_eegcnsbywv`
    ADD UNIQUE INDEX `col_jophiowutg`(`col_jophiowutg`(2),`col_pnotecfjsi`);
ALTER TABLE `tb_eegcnsbywv`
    ADD UNIQUE `col_trrvagfhxb`(`col_trrvagfhxb`(20),`col_hfrmqomgva`);
ALTER TABLE `tb_eegcnsbywv`
    ALTER COLUMN `col_eawvokgzvi` DROP DEFAULT;
