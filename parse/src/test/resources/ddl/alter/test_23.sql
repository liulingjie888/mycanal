...
RENAME
TABLE `tb_eroteuzada` TO `tb_thlwjjfpcg`;
RENAME
TABLE `tb_thlwjjfpcg` TO `tb_ydbfvvwhvi`;
ALTER TABLE `tb_caahynuejc`
    ADD COLUMN `col_noipbutgvd` char CHARACTER SET utf8mb4 NULL;
ALTER TABLE `tb_caahynuejc` ADD (`col_eyefseknmn` time DEFAULT '00:00:00', `col_nxbdoexmux` bigint(139) zerofill NULL);
ALTER TABLE `tb_caahynuejc`
    ADD `col_aulqirvfec` tinyblob;
...
ALTER TABLE `tb_caahynuejc`
    ADD UNIQUE KEY `uk_kvrvlewpkc` (`col_bufdgcwxci`);
ALTER TABLE `tb_caahynuejc`
    ALTER `col_eyefseknmn` DROP DEFAULT;
