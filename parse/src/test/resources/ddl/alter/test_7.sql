...
RENAME
TABLE `tb_edzrjofyjy` TO `tb_dhnyjpcqwn`;
RENAME
TABLE `tb_dhnyjpcqwn` TO `tb_pdshedxikd`;
RENAME
TABLE `tb_pdshedxikd` TO `tb_nuprsugtcj`;
ALTER TABLE `tb_nuprsugtcj`
    ADD `col_ezppromjmx` int(120) unsigned zerofill NULL;
...
ALTER TABLE `tb_nuprsugtcj`
    ADD UNIQUE KEY (`col_iyhhfsuidc`);
ALTER TABLE `tb_nuprsugtcj`
    ADD UNIQUE KEY `uk_mmyhqwqrpg` (`col_ezppromjmx`);
ALTER TABLE `tb_nuprsugtcj`
    ALTER COLUMN `col_qwsjkklpfs` SET DEFAULT NULL;
ALTER TABLE `tb_nuprsugtcj`
    ALTER COLUMN `col_qwsjkklpfs` DROP DEFAULT;
